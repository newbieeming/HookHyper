...
import com.newbieeming.hookhyper.feature.settings.LocalSettingsViewModel
...
class DeviceSettingsHookContent : HookContent {

    override val preferenceKey = SettingsHookDef.EDIT_DEVICE_INFO.preferenceKey
    override val category = SettingsHookDef.EDIT_DEVICE_INFO.category
    override val order = SettingsHookDef.EDIT_DEVICE_INFO.order
